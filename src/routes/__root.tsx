...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Multi-country banking: pay utility & mobile bills, transfer, deposit, withdraw, and send internationally — under each central bank's rules, with an integrated Pi Network wallet." },
      { name: "author", content: "Meridian Bank" },
      { property: "og:title", content: "Meridian Bank — Global banking, Pi-enabled" },
      { property: "og:description", content: "Jurisdiction-aware banking with a built-in Pi Network wallet." },
